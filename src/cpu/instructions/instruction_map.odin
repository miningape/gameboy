...
MAPPING :: proc() -> [0x100]Instruction {
  return {
    ...
    /* 0 */ NOOP,                              {LD, op.BC, next2Bytes, F_NO}, {LD, op.BC_ptr, op.A, F_NO},     {INC, op.BC, nil, F_NO},      {INC, op.B, nil, F_ZNH},            {DEC, op.B, nil, F_ZNH},            {LD, op.B, nextByte, F_NO},      NOOP,                        {LD_2_bytes, next2Bytes, op.SP, F_NO}, NOOP,                     {LD, op.A, op.BC_ptr, F_NO},     {DEC, op.BC, nil, F_NO},   {INC, op.C, nil, F_ZNH}, {DEC, op.C, nil, F_ZNH}, {LD, op.C, nextByte, F_NO},   NOOP,
    ...
    /* 2 */ {JR, NZ, nextByte, F_NO},          {LD, op.HL, next2Bytes, F_NO}, {LDI, op.HL, op.A, F_NO},        {INC, op.HL, nil, F_NO},      {INC, op.H, nil, F_ZNH},            {DEC, op.H, nil, F_ZNH},            {LD, op.H, nextByte, F_NO},      NOOP,                        {JR, Z, nextByte, F_NO},               NOOP,                     {LDI, op.A, op.HL, F_NO},        {DEC, op.HL, nil, F_NO},   {INC, op.L, nil, F_ZNH}, {DEC, op.L, nil, F_ZNH}, {LD, op.L, nextByte, F_NO},   {CPL, op.A, nil, F_ALL}, 
    /* 3 */ {JR, NC, nextByte, F_NO},          {LD, op.SP, next2Bytes, F_NO}, {LDD, op.HL, op.A, F_NO},        {INC, op.SP, nil, F_NO},      {INC, op.HL_ptr, nil, F_ZNH},       {DEC, op.HL_ptr, nil, F_ZNH},       {LD, op.HL_ptr, nextByte, F_NO}, {SCF, nil, nil, F_ALL},      {JR, C, nextByte, F_NO},               NOOP,                     {LDD, op.A, op.HL, F_NO},        {DEC, op.SP, nil, F_NO},   {INC, op.A, nil, F_ZNH}, {DEC, op.A, nil, F_ZNH}, {LD, op.A, nextByte, F_NO},   {CCF, nil, nil, F_ALL}, 
