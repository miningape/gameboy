...
MAPPING :: proc() -> [0x100]Instruction {
  return {
    ...
    /* F */ {LD, op.A, nextByteHramPtr, F_NO}, NOOP,                          {LD, op.A, op.C_hram_ptr, F_NO}, NOOP,                         NOOP,                               NOOP,                               {OR, op.A, nextByte, F_ALL},     NOOP,                        NOOP,                                  NOOP,                    {LD, op.A, next2BytesPtr, F_NO}, NOOP,                      NOOP,                    NOOP,                    {CP, op.A, nextByte, F_ALL},  NOOP, 
  }
}
