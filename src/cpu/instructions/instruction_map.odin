...
MAPPING :: proc() -> [0x100]Instruction {
  return {
    ...
    /* 2 */ {JR, NZ, nextByte, F_NO},    {LD, op.HL, next2Bytes, F_NO}, {LDI, op.HL_ptr, op.A, F_NO}, {INC, op.HL, nil, F_NO},      {INC, op.H, nil, F_ZNH},            {DEC, op.H, nil, F_ZNH},            {LD, op.H, nextByte, F_NO},      NOOP,                        {JR, Z, nextByte, F_NO},       NOOP,                    {LDI, op.A, op.HL_ptr, F_NO}, {DEC, op.HL, nil, F_NO}, {INC, op.L, nil, F_ZNH}, {DEC, op.L, nil, F_ZNH}, {LD, op.L, nextByte, F_NO},   NOOP, 
    /* 3 */ {JR, NC, nextByte, F_NO},    {LD, op.SP, next2Bytes, F_NO}, {LDD, op.HL_ptr, op.A, F_NO}, {INC, op.SP, nil, F_NO},      {INC, op.HL_ptr, nil, F_ZNH},       {DEC, op.HL_ptr, nil, F_ZNH},       {LD, op.HL_ptr, nextByte, F_NO}, NOOP,                        {JR, C, nextByte, F_NO},       NOOP,                    {LDD, op.A, op.HL_ptr, F_NO}, {DEC, op.SP, nil, F_NO}, {INC, op.A, nil, F_ZNH}, {DEC, op.A, nil, F_ZNH}, {LD, op.A, nextByte, F_NO},   NOOP, 
    ...
    /* A */ NOOP,                        NOOP,                          NOOP,                         NOOP,                         NOOP,                               NOOP,                               NOOP,                            NOOP,                        {XOR, op.B, nil, F_ALL},       {XOR, op.C, nil, F_ALL}, {XOR, op.D, nil, F_ALL},      {XOR, op.E, nil, F_ALL}, {XOR, op.H, nil, F_ALL}, {XOR, op.L, nil, F_ALL}, {XOR, op.HL_ptr, nil, F_ALL}, {XOR, op.A, nil, F_ALL}, 
    ...
    /* E */ NOOP,                        NOOP,                          NOOP,                         NOOP,                         NOOP,                               NOOP,                               NOOP,                            NOOP,                        {ADD, op.SP, nextByte, F_ALL}, {JP, op.HL, nil, F_NO},  NOOP,                         NOOP,                    NOOP,                    NOOP,                    {XOR, nextByte, nil, F_ALL},  NOOP, 
