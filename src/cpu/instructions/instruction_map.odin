...
MAPPING :: proc() -> [0x100]Instruction {
  return {
    ...
    /* E */ {LD, nextByteHramPtr, op.A, F_NO}, NOOP,                          {LD, op.C_hram_ptr, op.A, F_NO}, NOOP,                         NOOP,                               NOOP,                               {AND, op.A, nextByte, F_ALL},    NOOP,                        {ADD, op.SP, nextByte, F_ALL}, {JP, op.HL, nil, F_NO},  NOOP,                         NOOP,                      NOOP,                    NOOP,                    {XOR, nextByte, nil, F_ALL},  NOOP, 
    /* F */ {LD, op.A, nextByteHramPtr, F_NO}, NOOP,                          {LD, op.A, op.C_hram_ptr, F_NO}, NOOP,                         NOOP,                               NOOP,                               {OR, op.A, nextByte, F_ALL},     NOOP,                        NOOP,                          NOOP,                    NOOP,                         NOOP,                      NOOP,                    NOOP,                    {CP, op.A, nextByte, F_ALL},  NOOP, 
  }
}
