...
MAPPING :: proc() -> [0x100]Instruction {
  ...
  return {
    ...
    /* 0 */ NOOP,                {LD, op.BC, next2Bytes}, {LD, Pointer {op.BC}, op.A}, {INC, op.BC, nil},     {INC, op.B, nil},            NOOP,             {LD, op.B, nextByte}, NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                 {INC, op.C, nil},       NOOP,                  {LD, op.C, nextByte}, NOOP,
    /* 1 */ NOOP,                {LD, op.DE, next2Bytes}, {LD, Pointer {op.DE}, op.A}, {INC, op.DE, nil},     {INC, op.D, nil},            NOOP,             {LD, op.D, nextByte}, NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                 {INC, op.E, nil},       NOOP,                  {LD, op.E, nextByte}, NOOP, 
    /* 2 */ NOOP,                {LD, op.HL, next2Bytes}, NOOP,                        {INC, op.HL, nil},     {INC, op.H, nil},            NOOP,             {LD, op.H, nextByte}, NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                 {INC, op.L, nil},       NOOP,                  {LD, op.L, nextByte}, NOOP, 
    /* 3 */ NOOP,                {LD, op.SP, next2Bytes}, NOOP,                        {INC, op.SP, nil},     {INC, Pointer {op.HL}, nil}, NOOP,             NOOP,                 NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                 {INC, op.A, nil},       NOOP,                  {LD, op.A, nextByte}, NOOP, 
