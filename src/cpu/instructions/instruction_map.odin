...
MAPPING :: proc() -> [0x100]Instruction {
  ...
  return {
    ...
    /* 0 */ NOOP,                {LD, op.BC, next2Bytes}, {LD, Pointer {op.BC}, op.A}, {INC, op.BC, nil},     NOOP,                        NOOP,             {LD, op.B, nextByte}, NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  {LD, op.C, nextByte}, NOOP,
    /* 1 */ NOOP,                {LD, op.DE, next2Bytes}, {LD, Pointer {op.DE}, op.A}, {INC, op.DE, nil},     NOOP,                        NOOP,             {LD, op.D, nextByte}, NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  {LD, op.E, nextByte}, NOOP, 
    ...
    /* 3 */ NOOP,                {LD, op.SP, next2Bytes}, NOOP,                        {INC, op.SP, nil},     {INC, Pointer {op.HL}, nil}, NOOP,             NOOP,                 NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  NOOP,                  {LD, op.A, nextByte}, NOOP, 
